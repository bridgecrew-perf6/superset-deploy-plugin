...
DEFAULT_FEATURE_FLAGS: Dict[str, bool] = {
    ...
    "DASHBOARD_NATIVE_FILTERS": True,      #False
    "DASHBOARD_CROSS_FILTERS": True,       #False
    "DASHBOARD_NATIVE_FILTERS_SET": True,  #False
